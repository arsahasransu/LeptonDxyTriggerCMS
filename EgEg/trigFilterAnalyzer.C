...
void trigFilterAnalyzer::analyzersinglefile(int splitCnt) { // Assume splitCnt to range from 0 to nCores
  ...
  addgenhist("genptgt10barsel_time1nsmch");
  addgenhist("genptgt10barsel_sminlt0p16mch");
  ...
  for(unsigned int event=beginevent; event<endevent; event++) {
    ...
    vector<bool> genptgt10barsel_time1nsmchegidxdec = genptgt10barselegidxdec;
    vector<bool> genptgt10barsel_sminlt0p16mchegidxdec = genptgt10barselegidxdec;
    ...
    if(HLT_DiPhoton10Time1ns>0 && HLT_DiPhoton10sminlt0p16<0) cout<<"Found event that proves complementary triggers."<<endl;
    ...
    combineFiltmchForGen(genptgt10barselegidx, time1nsmchgenptgt10barselidx, &genptgt10barsel_time1nsmchegidxdec);
    fillgenhistinevent("genptgt10barsel_time1nsmch",genptgt10barselegidx, genptgt10barsel_time1nsmchegidxdec);

    combineFiltmchForGen(genptgt10barselegidx, sminlt0p16mchgenptgt10barselidx, &genptgt10barsel_sminlt0p16mchegidxdec);
    fillgenhistinevent("genptgt10barsel_sminlt0p16mch",genptgt10barselegidx, genptgt10barsel_sminlt0p16mchegidxdec);
    ...
    genptgt10barsel_time1nsmchegidxdec.clear();
    genptgt10barsel_sminlt0p16mchegidxdec.clear();
