...
int analyzer_mumu_singlefile(TString inrootfile, TString outrootfile) {
  ...
  // Genlevel objects
  auto genmumu_mult = new TH1F("genmumu_mult","#mu N",5,0,5);
  ...
  auto genmumu_egdR = new TH1F("genmumu_egdR", "#DeltaR(#mu, #mu)",10000,0,5);
  ...
  std::cout<<"Event with 2 muons: "<<evtwith2mu<<endl;
  std::cout<<"Event with 2 muons, pT>15: "<<evtwith2mupt15<<endl;
